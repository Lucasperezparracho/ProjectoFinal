...
This is the readme for SimulatorProject, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. SimulatorProject) > Ok.
...
- To run the project find SimulatorProject.java (which will be in under src/main/java/lucas) and right click > Run 'SimulatorProject'
