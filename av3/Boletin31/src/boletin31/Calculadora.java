...
public class Calculadora extends javax.swing.JFrame {
    ...
    jTextField1.setText(jTextField1.getText() + "8");    }//GEN-LAST:event_jButton2ActionPerformed
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        // Obtener la expresión matemática del cuadro de texto
    String expresion = jTextField1.getText();
    
    // Separar la expresión en operandos y operador
    String[] partes = expresion.split("[+\\-*/]");
    double primerOperando = Double.parseDouble(partes[0]);
    double segundoOperando = Double.parseDouble(partes[1]);
